...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                    ...
                    <a class="btn btn-success" href="{{ route('product.create') }}"><i class="fa fa-plus"></i> Create New</a>
    ...
    <div class="row-fluid">
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-info" href="{{ route('product.show',$item->id) }}"><i class="fa fa-external-link"></i></a>
